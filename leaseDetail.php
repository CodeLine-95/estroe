...
if (empty($_COOKIE['user'])) {
	...
	$str = substr($str,0,-1);
	//点击次数
	$select = $mysqli->query("select list_seetimes from lease where list_id={$gid}");
	if ($select) {
		while ($id = $select->fetch_assoc()) {
			$ida = $id;
		}
	}
	$update = $mysqli->query("update lease set list_seetimes={$ida['list_seetimes']}+1 where list_id={$gid}");
	//执行SQL语句
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="content" style="margin:0;">
				<div id="goodinfo" style="width:auto;">
					<div class="gdImg" style="width: 256px;">
						<img src="<?php echo $two_arr['list_face']?>" width="250" height="250">
						<span class="buy">
							<a href="afterOrder.php?act=leases&id=<?php echo $gid;?>">购买</a>
						</span>
						<!-- <span class="fav">
							<a href="#">收藏</a>
						</span> -->
					...
					<div class="gdInfo" style="width: 604px;">
						<h4 style="width:auto;"><?php echo $two_arr['list_name']?></h4>
            ...
            <p>押金：￥<label style="color:red"><?php echo $two_arr['deposit']?></label></p>
					...
					<div style="margin-top:10px;">
						...
						<form class="tabcontent" action="evaluate_add.php" method="post">
							<div class="">
								...
								<input type="hidden" name="act" value="lease">
