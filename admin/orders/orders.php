...
$res_obj = $mysqli->query("select * from orders");

$two_arr = findAll("select * from orders",$mysqli);
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo $one['createtime'];?></td>
                <td>
                  <a href="/admin/orders/orders_edit.php?act=edit&id=<?php echo $one['orderid'];?>">查看</a>
                  <a href="/admin/orders/orders_del.php?act=del&id=<?php echo $one['orderid'];?>">删除</a>
                </td>
              </tr>
              <?php endforeach;?>
            </tbody>
