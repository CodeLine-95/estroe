...
if (isPost()) {
  ...
  switch ($face['error']) {
      case 0:
          ...
          if ($type == 'image/jpeg' || $type == 'image/ipg' || $type == 'image/png' || $type == 'image/gif') {
              ...
              echo "<script>alert('必须使用图片！');window.location.href='/admin/leases/leases_add.php';</script>";die;
          }
          break;
      //图片的错误判断
      case 1:
      case 2:
          echo "<script>alert('文件超出指定大小！');window.location.href='/admin/leases/leases_add.php';</script>";die;
          break;
      case 3:
          echo "<script>alert('网络不稳定，请重新上传！');window.location.href='/admin/leases/leases_add.php';</script>";die;
          break;
      case 4:
          echo "<script>alert('不能是空文件！');window.location.href='/admin/leases/leases_add.php';</script>";die;
          break;
  }
  ...
  $mysqli->close();
  if ($result) {
    echo "<script>alert('创建成功');window.location.href='leases.php';</script>";
  }else{
    echo "<script>alert('创建失败');window.location.href='leases_add.php';</script>";
  }
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>estore管理系统后台——租赁表创建</title>
    <style media="screen">
      *{
        outline: none;
      }
  ...
  <body>
    ...
    <div class="admin_content">
      <div class="card">
        ...
        <div class="card-body">
          <form action="leases_add.php" method="post" enctype="multipart/form-data">
            <div class="form-item">
              <label>商品名称</label>
            ...
            <div class="form-item" id="is_lease">
              <label>租赁天数</label>
              <input type="text" name="lease_time" value="">
            </div>
            <div class="form-item" id="is_lease">
              <label>押金</label>
            ...
            <div class="form-item">
              <label>库存量</label>
              <input type="text" name="list_nums" value="">
            </div>
